		...
		elseif($_POST['sha256'] == 'SHA256')
			...
			elseif($_POST['crc32'] == 'CRC32')
				...
				elseif($_POST['tech-vegan'] == 'TECH-VEGAN')
					...
					// Form-II
					if($_POST['base64'] == "ENCRYPT")
					{
						$plainText = $_POST['cp'];
						$base64_output = base64_encode($plainText);
					}
					
					if($_POST['base64'] == "DECRYPT")
					{
						$plainText = $_POST['cp'];
						$base64_output = base64_decode($plainText);
					}
...
<div class="mb-3">
  ...
  <input type="text" class="form-control form-control-lg" id="exampleFormControlInput1" name="cp" placeholder="Enter Plain Text" required>
</div>
<div class="mb-3">
	<input type="submit" value="ENCRYPT" name="base64" class="btn btn-lg btn-outline-danger">
    <input type="submit" value="DECRYPT" name="base64" class="btn btn-lg btn-outline-success">
</div>

</form>
<div class="mb-3">
  <label for="exampleFormControlTextarea1" class="form-label"><strong class="display-6">CIPHER TEXT</strong></label>
  <textarea class="form-control" id="exampleFormControlTextarea1" rows="2" style="font-size:40px;"><?php echo $base64_output;?></textarea>
  </div>
  <div class="mb-3">
  <button type="button" class="btn btn-danger">
  Length <span class="badge bg-secondary"><?php echo strlen($base64_output);?></span>
</button>
</div>
